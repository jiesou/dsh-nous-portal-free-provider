...
export async function pollForToken(challenge: DeviceCodeChallenge, options: {
  portalUrl?: string
  clientId?: string
  signal?: AbortSignal
  onPending?: () => void
 ...
 */
export async function refreshAccessToken(grant: NousPortalGrant, signal?: AbortSignal): Promise<TokenResponse> {
